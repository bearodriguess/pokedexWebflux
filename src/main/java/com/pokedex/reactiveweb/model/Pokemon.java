...
public class Pokemon {
	...
	public Pokemon(String id, String nome, String habilidades, String categoria, Double peso) {
		super();
		this.id = id;
		this.nome = nome;
	...
	public String toString() {
		return "Pokemon [id=" + id + ", nome=" + nome + ", habilidades=" + habilidades + ", categoria=" + categoria
				+ ", peso=" + peso + "]";
	}
	@Override
	public int hashCode() {
